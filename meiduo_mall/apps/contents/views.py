...
# 上传文件(使用绝对路径)
client.upload_by_filename('/home/wch/Desktop/123/7.jpg')
# 获取上传成功之后的数据
"""
getting connection <fdfs_client.connection.Connection object at 0x7f8b3142a160> 
<fdfs_client.fdfs_protol.Tracker_header object at 0x7f8b3142a128> {'Storage IP': '192.168.60.128', 'Group name': 
